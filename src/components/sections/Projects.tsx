...
// const projects = [
//   {
//     title: "Tripura State Election Commission",
//     description:
//       "A modern election management portal built using React, TypeScript and Material UI with district-wise election results, candidate details and responsive UI.",
...
//     description:
//       "A premium portfolio website built using Next.js, Tailwind CSS and Framer Motion featuring animations, responsive design and modern UI.",
...
//     description:
//       "A contractor registration platform with authentication, document upload and profile management.",
...
//         like React, Next.js, TypeScript, Tailwind CSS and Material UI.
//       </p>
...
//             y: -10,
//           }}
//           className="group overflow-hidden rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl transition-all duration-300 hover:border-violet-500 hover:shadow-[0_0_30px_rgba(139,92,246,.20)]"
//         >
//           {/* Project Image */}
...
//                 <span
//                   key={tech}
//                   className="rounded-full border border-violet-500/20 bg-violet-500/10 px-3 py-1 text-xs font-semibold text-violet-300"
//                 >
//                   {tech}
//                 </span>
//               ))}
...
//                 href={project.github}
//                 target="_blank"
//                 className="inline-flex items-center gap-2 rounded-full border border-white/10 px-5 py-3 text-white transition-all duration-300 hover:border-violet-500 hover:text-violet-400"
//               >
...
//                 href={project.live}
//                 target="_blank"
//                 className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-violet-600 to-cyan-500 px-5 py-3 font-semibold text-white transition-all duration-300 hover:scale-105"
//               >
//                 Live Demo
...
//       transition={{ duration: 0.8 }}
//       viewport={{ once: true }}
//       className="mt-20 rounded-3xl border border-white/10 bg-gradient-to-r from-violet-500/10 to-cyan-500/10 p-10 text-center backdrop-blur-xl"
//     >
...
//         I&apos;m continuously building new applications, learning new
//         technologies and improving my development skills. Visit my GitHub
//         profile to explore more of my work.
//       </p>
