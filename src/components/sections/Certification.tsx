...
//             Certifications and achievements that demonstrate my commitment to
...
//               scale: 1.02,
//             }}
//             className="group rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl transition-all duration-300 hover:border-violet-500 hover:shadow-[0_0_30px_rgba(139,92,246,.25)]"
//           >
//             {/* Certificate Icon */}
...
//             <div className="mt-5 inline-block rounded-full bg-cyan-500/10 px-4 py-2 text-sm font-semibold text-cyan-300">
//               {certificate.date}
//             </div>
...
//               target="_blank"
//               className="mt-8 inline-flex items-center gap-2 font-semibold text-cyan-400 transition hover:text-violet-400"
//             >
//               View Certificate
...
//             building real-world projects and completing professional courses.
//             My goal is to become a highly skilled Full Stack Developer.
//           </p>

//           <Link
//             href="#contact"
//             className="mt-8 inline-flex items-center rounded-full bg-gradient-to-r from-violet-600 to-cyan-500 px-8 py-4 font-semibold text-white transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-violet-500/30"
//           >
//             Let's Connect
//           </Link>
//         </motion.div>
